...
class FakeDXGIFactory : public IDXGIFactory7
{
private:
	IDXGIFactory7* real;

public:
	FakeDXGIFactory(IDXGIFactory7* real);
	...
	virtual HRESULT __stdcall RegisterAdaptersChangedEvent(HANDLE hEvent, DWORD* pdwCookie) override;
	virtual HRESULT __stdcall UnregisterAdaptersChangedEvent(DWORD dwCookie) override;
};